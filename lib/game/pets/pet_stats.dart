...
class PetStats {
  ...
  /// Coins and inventory are written first so that the most
  /// critical data survives even if the save is interrupted mid-way
  /// (e.g. the Flutter engine is torn down while the app is being killed).
  Future<void> saveToPrefs() async {
    ...
    // Stats and timestamp (can be recalculated / are less critical).
